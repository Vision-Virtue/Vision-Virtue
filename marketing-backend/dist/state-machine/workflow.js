...
const VALID_TRANSITIONS = {
    ...
    AWAITING_RAPHAEL_APPROVAL: ['APPROVED_FOR_PUBLISHING', 'RETURNED_FOR_REVISION', 'REJECTED', 'RETURNED_TO_VP_FOR_CORRECTIONS'],
    RETURNED_TO_VP_FOR_CORRECTIONS: ['AWAITING_RAPHAEL_APPROVAL'],
