...
export function chiefEconomistPrompt(topic: string, today: string, withSearch = false): string {
...
export function cfoVisibilitySystemPrompt(context: Record<string, unknown>): string {
